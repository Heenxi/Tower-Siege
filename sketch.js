...
function draw() {
  ...
  rectMode(CENTER);
  ground.display();
  box1.display("blue", "green");
  box2.display("lightblue", "green");
  box3.display("red", "green");
  box4.display("red", "green");
  box5.display("blue", "green");
  box6.display("indigo", "green");
  box7.display("indigo", "green");
  box8.display("indigo", "green");
  box9.display("indigo", "green");
  box10.display("green", "green");
  box11.display("green", "green");
  box12.display("green", "green");
  box13.display("orange", "green");
  box14.display("orange", "green");
  box15.display("blue", "green");
  ...
  stand1.display();
  stand2.display();
  ball.display("darkblue", "green");
  textSize(35);
  fill(0);
  text("DRAG AND RELEASE THE BALL TO DESTROY THE BOXES", 150, 385)
  fill("orange");
  textSize(20);
  text("PRESS SPACE FOR MORE LIVES",60,20)
